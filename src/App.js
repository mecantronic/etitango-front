...
function App() {
  ...
  const [idNewEvent, setIdNewEvent] = useState({ idNewEvent: {} });
  ...
  return (
    <div className="mainContainer">
      <UserContext.Provider value={{ user, setUser }}>
        <EventContext.Provider value={{ idNewEvent, setIdNewEvent }}>
              ...
              >
                <Routes>
                  ...
                  <Route
                    ...
                    element={withUserMenu(ManifiestoETiano)()}
                    exact
                  />
                  <Route
                  ...
                  />
                  <Route
                    path={`${ROUTES.RECEIPTS}/:etiEventId`}
                    element={withUserMenu(Receipt)()}
                  />
