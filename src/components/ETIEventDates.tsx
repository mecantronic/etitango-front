                ...
                <Box sx={{ display: 'flex', mr: 1, alignItems: 'center' }}>
                  {userIsSuperAdmin ? (
                    <>
                      {!enable && (
                        <Typography
                          sx={{ fontWeight: 600, fontSize: '24px', color: '#0075D9', mr: 1 }}
                        >
                          {selectedEvent?.name}
                        </Typography>
                      )}
                      ...
                      <Button onClick={() => handleEditDataEvent(values)}>
                        <img
                          src={enable ? '/img/icon/btnConfirm.svg' : '/img/icon/Button_modify.svg'}
                          height={25}
                          width={25}
                        />
                      </Button>
                    ...
                    <Typography sx={{ fontWeight: 600, fontSize: '24px', color: '#0075D9', mr: 1 }}>
                      {selectedEvent?.name}
                    </Typography>
                  )}
                </Box>
                      ...
                      <Grid item md={4} sm={4} xs={4}>
                        ...
                        >
                          ...
                          <Box sx={{ width: '100px', ml: 6 }}>
                            <Typography
                              style={{ fontFamily: 'inter', color: '#0075D9', fontSize: '16px' }}
                            >
                              a las
                            </Typography>
                          </Box>
