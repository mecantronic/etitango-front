...
const ETIModalDeleteEvent = React.forwardRef(
  (
    props: {
    ...
    const { handleCloseModal, handleDeleteButton, title, subtitle } = props;

    return (
      <Box ref={ref} sx={{ ...styleModal }}>
        <Box
          sx={{
            display: 'flex',
        ...
        >
          ...
          <Box
            sx={{ borderBottom: `1px solid ${theme.palette.greyScale[300]}`, width: '100%' }}
          ></Box>
          {!isMobile && (
            <Box sx={{ mt: 2 }}>
            ...
            <Box>
              <Button
                sx={{
                  ...
                  border: `1px solid ${theme.palette.greyScale[500]}`,
                  height: '44px',
                  width: '104px',
                  borderRadius: '25px',
                  gap: '8px',
